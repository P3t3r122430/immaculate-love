...
class Heart {
  ...
  draw() {
    ...
    heartsCtx.bezierCurveTo(this.x - this.size, this.y - this.size, this.x - this.size, this.y + this.size/2, this.x, this.y + this.size);
    heartsCtx.bezierCurveTo(this.x + this.size, this.y + this.size/2, this.x + this.size, this.y - this.size, this.x, this.y);
    heartsCtx.fill();
  }
  update() {
    this.y -= this.speed;
